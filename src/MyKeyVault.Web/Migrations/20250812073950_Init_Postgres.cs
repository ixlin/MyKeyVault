        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountNameEncrypted = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CryptoVersion = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_UserId_CreatedAt",
                table: "Accounts",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AccountTags_AccountId_TagId",
                table: "AccountTags",
                columns: new[] { "AccountId", "TagId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccountTags_TagId",
                table: "AccountTags",
                column: "TagId");
