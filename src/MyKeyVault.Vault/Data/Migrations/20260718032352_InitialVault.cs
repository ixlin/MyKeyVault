        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Result = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    RequestCorrelationId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlOrHost = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaultItems_OwnerId_Title",
                table: "VaultItems",
                columns: new[] { "OwnerId", "Title" });

            migrationBuilder.CreateIndex(
                name: "IX_VaultItems_OwnerId_UpdatedAtUtc",
                table: "VaultItems",
                columns: new[] { "OwnerId", "UpdatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_VaultSecrets_VaultItemId_FieldName",
                table: "VaultSecrets",
                columns: new[] { "VaultItemId", "FieldName" },
                unique: true);
        }
